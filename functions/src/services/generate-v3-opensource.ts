...
export async function GenerateStoryV3({ charaters, environments, storyId, user, genres, language, languageLevel, wordCount, customStoryDescriptor, referanceStory, narrationStyle, voice }: IGenerateStoryProps): Promise<IGenerateStoryResponse> {
