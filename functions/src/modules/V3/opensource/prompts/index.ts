...
import { promptForUserInputsAndChapters as promptForUserInputsAndChaptersEnglish, promptForEachChapter as promptForEachChapterEnglish, askExtraWords as askExtraWordsEnglish, promptForSystem as promptForSystemEn, promptForDialogueSystem as promptForDialogueSystemEn } from './en'
import { promptForUserInputsAndChapters as promptForUserInputsAndChaptersSpanish, promptForEachChapter as promptForEachChapterSpanish, askExtraWords as askExtraWordsSpanish, promptForSystem as promptForSystemEs, promptForDialogueSystem as promptForDialogueSystemEs } from './sp'
...
// Prompt for Dialogue System
export const promptForDialogueSystem = (storyLangauge: Languages) => {
    if (storyLangauge === "en-US") {
        return promptForDialogueSystemEn()
    } else if (storyLangauge === "es-ES") {
        return promptForDialogueSystemEs();
    }
